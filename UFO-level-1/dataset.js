...
data.forEach(function(dict){
  ...
  row.append("td").text(dict.datetime);
  row.append("td").text(dict.city);
  row.append("td").text(dict.state);
  row.append("td").text(dict.country);
  row.append("td").text(dict.shape);
  row.append("td").text(dict.durationMinutes);
  row.append("td").text(dict.comments);
